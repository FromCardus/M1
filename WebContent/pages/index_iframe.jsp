	...
	<script type="text/javascript">
		...
		function search_menu() {
			...
			$ul.find("a.nav-link").each(function() {
				...
				//å¤æ­æ¯å¦å«æè¦æç´¢çå­ç¬¦ä¸²
				if ($a.children("span.menu-text").text().indexOf(text) >= 0) {

					//å¦æaæ ç­¾çç¶çº§æ¯éèçå°±å±å¼
					$ul = $a.parents("ul");
		...
		$(function() {
			...
			var menus = [ {
				...
				children : [ {
					...
					id : "90012",
					text : "教师",
					/* url : "${path}/pages/tables/data.jsp" */ 
					url:"lsteacher.do",
					targetType : "iframe-tab",
					icon : "fa fa-circle-o"
				}, {
				...
				children : [ {
					id : "90021",
					text : "advanced",
					url : "pages/forms/advanced_iframe.html",
					targetType : "iframe-tab",
					icon : "fa fa-circle-o"
				}, {
					id : "90022",
					text : "general",
					url : "pages/forms/general_iframe.html",
					targetType : "iframe-tab",
					icon : "fa fa-circle-o"
				}, {
					id : "90023",
			...
			// å¨æåå»ºèååï¼å¯ä»¥éæ°è®¡ç® SlimScroll
